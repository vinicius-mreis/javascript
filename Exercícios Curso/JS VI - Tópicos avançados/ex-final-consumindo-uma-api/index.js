...
function createTransactionAmount(amount) {
  ...
  const formater = Intl.NumberFormat("pt-BR", {
    ...
    currency: "BRL",
    style: "currency",
  }); // criar um objeto capaz de formatar nossos números
...
function createDeleteTransactionBtn(id) {
  ...
  deleteBtn.addEventListener("click", async () => {
    ...
    deleteBtn.parentElement.remove(); // parentElement -> container
...
async function saveTransaction(ev) {
  ...
  const amount = parseFloat(document.querySelector("#amount").value); // converter para número
